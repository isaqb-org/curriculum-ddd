...
== Status 
image:https://github.com/isaqb-org/curriculum-ddd/workflows/CI/badge.svg?branch=master["CI"]
...
== Content
This repository contains the curriculum for the iSAQB Advanced Level *DDD* in AsciiDoc.
