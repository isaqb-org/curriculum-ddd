...
* Die TN können die Beobachtungstechniken Feldbeobachtung und Apprenticing3 als Mittel zur Offenlegung unbewussten Domänenwissens anwenden:
** Feldbeobachtung
...
* The course participants can apply the observation techniques of “field observation” and “apprenticing”3 as tools for revealing unconscious domain knowledge:
** Field observation
