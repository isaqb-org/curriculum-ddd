...
[[LZ-3-1]]
==== LZ 3-1: Ein Domänenmodell um technisch motivierte Bausteine des Tactical Design erweitern können
...
[[LZ-3-2]]
==== LZ 3-2: Fachliche Klassen modellieren können
* Die TN können die Entwurfsprinzipien aus dem Foundation Level für den DDD-Entwurf einschätzen und anwenden.
...
[[LG-3-1]]
==== LG 3-1: Be able to extend a domain model with technically motivated building blocks of tactical design
...
[[LG-3-2]]
==== LG 3-2: Be able to model domain classes
* The course participants can assess and apply the design principles from the Foundation Level to the DDD design.
