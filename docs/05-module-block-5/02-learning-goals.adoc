...
[[LZ-5-6]]
==== LZ 5-6: Domain Events als Kommunikationsmittel zwischen Bounded Contexts nutzen können
...
[[LG-5-6]]
==== LG 5-6: Be able to use Domain Events as a means of communication between Bounded Contexts
