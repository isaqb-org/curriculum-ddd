...
- Grundlagen und weiterführende Konzepte der objektorientierten Software-Entwicklung
- Erfahrungen bei der Modellierung von objektorientierten Architekturen

**Hilfreich** für das Verständnis einiger Konzepte sind darüber hinaus:

- Wissen über agile Methoden der Software-Entwicklung, wie z. B. Scrum, Kanban, XP, etc. 
