...
* The course participants know that, in a customer/supplier relationship, the customer formulates the requirements on the supplier's interface.
...
* The course participants understand that the teams collaborate on the shared kernel as equals.
