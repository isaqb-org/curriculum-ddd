...
* Die TN verstehen die grundlegenden Bausteine des Tactical Design.
...
* Die TN verstehen die weiterführenden Bausteine des Tactical Design.
...
* The course participants understand the fundamental building blocks of tactical design.
...
* The course participants understand the additional building blocks of tactical design.
